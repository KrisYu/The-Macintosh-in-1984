...
class Puzzle: MacApp{
    ...
    var windowTitle: String? = "Puzzle"
    
    func sizeForWindow() -> CGSize {
        return SystemSettings.puzzleSize
    }
...
struct PuzzleDataModel{
    ...
    mutating func touch(at point: Point,inside puzzleView: PuzzelView?=nil){
